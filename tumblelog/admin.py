...
# admin.add_url_rule('/admin/hide/', defaults={'slug': None}, view_func=List.as_view('hide'))
# admin.add_url_rule('/admin/remove/', defaults={'slug': None}, view_func=LIst.as_view('remove'))